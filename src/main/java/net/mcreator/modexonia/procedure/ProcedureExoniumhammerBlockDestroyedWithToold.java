...
public class ProcedureExoniumhammerBlockDestroyedWithToold extends ElementsModexonia.ModElement {
	public ProcedureExoniumhammerBlockDestroyedWithToold(ElementsModexonia instance) {
		super(instance, 19);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ExoniumhammerBlockDestroyedWithToold!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure ExoniumhammerBlockDestroyedWithToold!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure ExoniumhammerBlockDestroyedWithToold!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure ExoniumhammerBlockDestroyedWithToold!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure ExoniumhammerBlockDestroyedWithToold!");
			return;
		}
